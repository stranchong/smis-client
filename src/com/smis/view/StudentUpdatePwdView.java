...
public class StudentUpdatePwdView implements OnClickListener {
	...
	// 定义接口对象
	private StudentUpdatePwdView.LoginDelegate dlg;

	public StudentUpdatePwdView(Activity ac, StudentUpdatePwdView.LoginDelegate delegate) {
		this.ac = ac;
		dlg = delegate;
