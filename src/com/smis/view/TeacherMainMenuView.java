...
public class TeacherMainMenuView implements OnItemClickListener {
	public interface LoginDelegate {
		public void switchActivity(int position);
	}

	private GridView gvMenus;
	private TeacherMainMenuView.LoginDelegate dlg;

	public TeacherMainMenuView(Activity ac, TeacherMainMenuView.LoginDelegate delegate) {
		dlg = delegate;
	...
	private class ImageAdapter extends BaseAdapter {
		...
		private String[] menuName = { "查看个人信息", "查看学生成绩", "录入学生成绩", "审批学生请假", "修改密码" };
